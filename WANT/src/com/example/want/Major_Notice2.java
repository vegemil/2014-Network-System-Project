		...
		new Thread()
		{
			...
			public void run()
			{
				...
				try
				{
					...
					Element table2 = (Element) source2.getAllElements(HTMLElementName.TABLE).get(3);
					Element table3 = (Element) source3.getAllElements(HTMLElementName.TABLE).get(3);
					Element table4 = (Element) source4.getAllElements(HTMLElementName.TABLE).get(3);
					...
					for(int i=0; i<tr_count; i=i+2)
					{
						tr2 = (Element) table2.getAllElements(HTMLElementName.TR).get(i); 
					...
					for(int i=0; i<tr_count; i=i+2)
					{
						tr3 = (Element) table3.getAllElements(HTMLElementName.TR).get(i); 
					...
					for(int i=0; i<tr_count; i=i+2)
					{
						tr4 = (Element) table4.getAllElements(HTMLElementName.TR).get(i); 
						td4= (Element) tr4.getAllElements(HTMLElementName.TD).get(1);
						aa4= (Element) td4.getAllElements(HTMLElementName.A).get(0);
						
						hm = new HashMap<String, String>();
						   
						hm.put("test", ((Element) tr4.getAllElements(HTMLElementName.TD).get(0)).getContent().toString());
